...
def main():
    ...
    write("plan",plan)
    request=document("request",{"schema_version":{"const":1},"id":{"type":"string","maxLength":64},"op":{"const":"search"},"query":{"type":"string","minLength":1,"maxLength":16384},"max_bytes":{"type":"integer","minimum":256,"maximum":1048576},"limit":{"type":"integer","minimum":1,"maximum":128},"catalog":{"type":"boolean"},"fields":{"type":"boolean"},"installed_only":{"type":"boolean"},"command":{"anyOf":[text,{"type":"null"}]}},["id","query"])
