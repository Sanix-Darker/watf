...
def main():
    ...
    write("plan",plan)
    request=document("request",{"schema_version":{"const":1},"id":{"type":"string","maxLength":64},"op":{"enum":["search","route","run"]},"query":{"type":"string","maxLength":16384},"plan":{"anyOf":[{"type":"null"},plan]},"cwd":{"anyOf":[text,{"type":"null"}]},"timeout_ms":{"type":"integer","minimum":1,"maximum":600000},"max_output_bytes":{"type":"integer","minimum":256,"maximum":1048576},"max_bytes":{"type":"integer","minimum":256,"maximum":1048576},"limit":{"type":"integer","minimum":1,"maximum":128},"catalog":{"type":"boolean"},"fields":{"type":"boolean"},"installed_only":{"type":"boolean"},"command":{"anyOf":[text,{"type":"null"}]}},["id"])
